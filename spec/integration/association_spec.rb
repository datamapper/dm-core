        ...
        repository(ADAPTER) do
          module Sweets
            class Shop
              ...
              has n, {:cakes => :recipe}, :class_name => 'Sweets::Recipe'                      # has n => has 1
              has n, {:cakes => :ingredients}, :class_name => 'Sweets::Ingredient'             # has n => has 1 => has n
              has n, {:cakes => :creator}, :class_name => 'Sweets::Creator'                    # has n => has 1 => has 1
              has n, {:cakes => :slices}, :class_name => 'Sweets::Slice'                       # has n => has n
              has n, {:cakes => :bites}, :class_name => 'Sweets::Bite'                         # has n => has n => has n
              has n, {:cakes => :shape}, :class_name => 'Sweets::Shape'                        # has n => has n => has 1
              has n, {:cakes => :customers}, :class_name => 'Sweets::Customer'                 # has n => belongs_to (pending)
              has 1, :shop_owner, :class_name => 'Sweets::ShopOwner'                           # has 1
              has 1, {:shop_owner => :wife}, :class_name => 'Sweets::Wife'                     # has 1 => has 1
              has 1, {:shop_owner => :ring}, :class_name => 'Sweets::Ring'                     # has 1 => has 1 => has 1
              has n, {:shop_owner => :coats}, :class_name => 'Sweets::Coat'                    # has 1 => has 1 => has n
              has n, {:shop_owner => :children}, :class_name => 'Sweets::Child'                # has 1 => has n
              has n, {:shop_owner => :toys}, :class_name => 'Sweets::Toy'                      # has 1 => has n => has n
              has n, {:shop_owner => :booger}, :class_name => 'Sweets::Booger'                 # has 1 => has n => has 1
            end
